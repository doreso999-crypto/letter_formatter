window.LETTER_CATEGORY_OPTIONS = [
  ...
  { key: 'FACTUAL', label: 'Factual', templateKey: 'factual', subject: 'Re: Request for Method of Verification – Inaccurate and Inconsistent Account Reporting', description: 'Request the Method of Verification for previously disputed account reporting.' },
  { key: 'DISMISSED_BANKRUPTCY', label: 'Dismissed Bankruptcy', templateKey: 'dismissedBankruptcy', subject: 'Re: Formal Dispute of Bankruptcy Reporting – Request for Immediate Correction/Deletion', description: 'Dispute bankruptcy reporting identified as dismissed.' },
  { key: 'DISCHARGED_BANKRUPTCY', label: 'Discharged Bankruptcy', templateKey: 'dischargedBankruptcy', subject: 'Re: Formal Dispute of Bankruptcy Reporting – Request for Immediate Correction/Deletion', description: 'Dispute bankruptcy reporting identified as discharged.' },
